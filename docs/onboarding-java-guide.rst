...
For a more detailed approach, you can follow the `Soup to nuts for JAVA <https://wiki.acumos.org/pages/resumedraft.action?draftId=28705403&draftShareId=de13026a-1fd0-4a3e-a26a-ab6e748a6d9a& >`_ that is a step by step guide to on-board a java model.
