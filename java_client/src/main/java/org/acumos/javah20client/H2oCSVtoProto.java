...
public class H2oCSVtoProto {
        ...
        public File writeToProto(String SAMPLE_CSV_FILE_PATH, String modelName, String h2oModelFullPath, List<String> h2oModelNameList)
                ...
                try {
                	...
                	logger.error("Cannot get model info for the h2o model. Check project setup and/or filename supplied." +e.getMessage());
                	throw new Exception("Cannot get model info for the h2o model. Check project setup and/or filename supplied.");
                }
